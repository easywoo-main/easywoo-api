...
@Module({
  imports: [StepChatMessageModule, ResultMessageChoiceModule, ResultSliderPropModule, ChatMessageModule, MessageChoiceModule, UserTextMessageAnswerModule, SubscriptionModule],
